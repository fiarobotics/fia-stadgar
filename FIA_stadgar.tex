...
\subsection{Tid för vårmöte}
Vårmötet skall hållas i början utav tredje läsperioden om det finns kandidater för någon av viceposterna.

\subsection{Mötets behöriga sammankallande}
För att vårmötet ska vara behörigt sammankallat ska:
\begin{itemize}
\item En kallelse ha skickats ut till samtliga medlemmar två veckor före mötet via e-post. Dagordningen för årsmötet ska vara bifogad i kallelsen.
\item Hälften eller tio (vilket som är minst) av föreningens medlemmar är närvarande.
\end{itemize}
\subsection{Rösträtt}
Endast närvarande medlem har rösträtt på årsmöte.
\subsection{Dagordning vid årsmöte}
Följande punkter ska behandlas och protokollföras av årsmötet:
\begin{enumerate}
\item Fastställande av röstlängd
\item Val av ordförande
\item Val av sekreterare för årsmötet
\item Val av justerare och tillika rösträknare
\item Godkännande av dagordning
\item Val av vice styrelseordförande
\item Val av vice kassör
\item Övriga frågor
\end{enumerate}
\subsection{Beslutsform}
Beslut i fråga som upptagits på dagordningen fattas med enkel majoritet. I ärenden upptagna under övriga frågor fordras 3/4-majoritet. För beslut om stadgeändring gäller särskilda regler, se §11
\subsection{Övriga frågor}
Under övriga frågor får ej ekonomiska beslut fattas.
...
\item Ledamöter
\end{itemize}
\subsection{Viceposter}
Styrelsen kan efter utfört vårmöte även innefatta följande poster:
\begin{itemize}
\item Vice ordförande
\item Vice kassör
\end{itemize}
\subsection{Mandattid och tillträde}
Vice styrelseroller från tidigare verksamhetsår övertar ordinarie roller för kommande verksamhetsår efter ordinarie årsmöte och innehar sina poster till nästa ordinarie årsmöte om de inte väljer att avgå eller avsätts genom misstroendeförklaring. Resterande styrelseroller tillträder efter ordinarie årsmöte och innehar sina poster till
...
Styrelsemedlemmar eller suppleanter kan entledigas av styrelsen om hen önskar avgå. Om en av firmatecknarna önskar avgå krävs dock ett extra årsmöte för att välja ny firmatecknare, såtillvida inte en viceroll kan överta arbetet. Beslut om ansvarsfrihet beviljas som vanligt av årsmötet, men styrelseledamoten kan endast hållas ansvarig för beslut som fattats innan entledigandet.
